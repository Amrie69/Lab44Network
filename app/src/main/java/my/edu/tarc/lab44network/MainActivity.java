...
public class MainActivity extends AppCompatActivity {
    ...
    List<Course> caList; //to hold records retrieved from the server
    private ProgressDialog pDialog; // a progress bar
    //TODO: Please update the URL to point to your own server
    private static String GET_URL = "http://bait2073.000webhostapp.com/select_course.php";
    RequestQueue queue; //A http request queue
    ...
    private boolean isConnected() {
        //Check the user device connectivity status
